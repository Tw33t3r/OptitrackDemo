...
namespace UnityStandardAssets.Characters.ThirdPerson
{
    ...
    public class Skeleton_AI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            //damageBox = this.gameObject.transform.Find("skeleton_knight_/skeleton_knight_ Pelvis/skeleton_knight_ Spine/skeleton_knight_ Spine1/skeleton_knight_ Spine2/skeleton_knight_ Neck/skeleton_knight_ R Clavicle/skeleton_knight_ R Upperarm/skeleton_knight_ R Forerarm/skeleton_knight_ R Hand/SWORD/DamageBox").gameObject;
