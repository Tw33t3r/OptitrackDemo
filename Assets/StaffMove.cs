...
public class StaffMove : MonoBehaviour {
    public string DeviceName = "Staff@10.2.224.199:3883";
                                      ...
                                      double quat_x, double quat_y, double quat_z, double quat_w)
    {
        ...
        GameObject.Find("Staff").transform.position = new Vector3((float)pos_x, (float)pos_y, -(float)pos_z);
         ...
         GameObject.Find("Staff").transform.rotation = trackerQuaternion;
