...
public class HammerMove : MonoBehaviour {
    public string DeviceName = "Hammer@10.2.224.199:3883";
                                      ...
                                      double quat_x, double quat_y, double quat_z, double quat_w)
    {
        ...
        GameObject.Find("Hammer").transform.position = new Vector3((float)pos_x, (float)pos_y, -(float)pos_z);
         ...
         GameObject.Find("Hammer").transform.rotation = trackerQuaternion;
